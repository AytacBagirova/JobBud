 ...
 const [offerPrice,setOfferPrice]=useState(0)
  ...
  return (
    ...
    <div className="card-footer">
      ...
      </div> <div class="modal fade" id={`exampleModalLabel${jobData.id}`} tabindex="-1" aria-labelledby={`exampleModalLabel${jobData.id}`} aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Make Offer</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Your offer for price:</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onClick={handleMakeOffer}>Send Offer</button>
      </div>
    </div>
  </div>
</div>
